...
> 📚 平台运营细节参考：dbskill/知识库/推文挖掘_04_实操运营.md
...
| 触发条件 | 推荐话术 |
|---|---|
| 对标确定，用户想开始做内容 | 「对标定了，选题方向可以用 `/dbs-topic` 检验一下。」 |
| 用户反复说"不适合我"，疑似心理卡点 | 「你可能不是在选对标，是在逃避执行。试试 `/dbs-unblock`。」 |

---

> 📚 深度参考：dbskill/知识库/推文挖掘_01_商业本体论.md、dbskill/知识库/推文挖掘_04_实操运营.md
